---
description: "Automation-only ACP (Agent Client Protocol) server for programmatic clients and maintainers driving OpenJev agents over JSON-RPC stdio."
