...
/**
 * The hero mark (34px wide). Hovering gives the mark a slight tilt through
 * CSS on the hitbox parent. Decorative — hidden from the accessibility tree.
...
function HeroFish({ hovering }: { hovering: boolean }) {
  return (
    <svg
      ...
      fill="none"
      aria-hidden="true"
      style={hovering ? { transform: 'rotate(-5deg) scale(1.04)' } : undefined}
    >
