...
const DESCRIPTION = 'Add the official “powered by OpenJev” badge to documents, pull requests, merge requests, and other content produced with OpenJev. Use whenever creating a pull request or merge request. Also use when the user asks for a dsh badge, powered-by-dsh attribution, or a reusable dsh badge asset or snippet.'
