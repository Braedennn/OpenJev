/**
 * Shared filesystem path helpers for OpenJev user data.
 *
...
/** Directory name for the default OpenJev home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default OpenJev home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default OpenJev home. */
...
/**
 * Resolve the default OpenJev home using Node's platform path rules.
...
/**
 * Resolve the single-root OpenJev home.
 *
...
/**
 * Join path segments onto the resolved OpenJev home.
