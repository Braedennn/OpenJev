...
export const en = {
  ...
  startupFailed: 'OpenJev is unavailable',
  ...
  updateDownloadedTitle: 'OpenJev v{version} downloaded',
...
export const zh = {
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'OpenJev v{version} 下载完成',
